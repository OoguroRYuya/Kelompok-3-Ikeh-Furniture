...
<head>
    ...
    <title>IKEH - Furniture Store</title>
    ...
    <main>
        <section class="hero">
            <div class="hero-text">
                ...
                <h1>Nyaman di Rumah, Gaya Sepanjang Masa!</h1>
                <p>Lengkapi rumah impianmu dengan furniture berkualitas dari IKEH. Nyaman, stylish, dan sesuai gaya kamu!</p>
                <a href="<?= site_url('furniture/'. $user_id) ?>" class="btn">Beli Sekarang</a>
            </div>
        </section>
    
        <section class="furniture" style="margin-top: 240px;">
