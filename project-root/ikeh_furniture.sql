...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2024 at 05:57 AM
...
(1, 'Modern Sofa', 'A comfortable modern sofa with a sleek design, perfect for any living room.', 1500.00, 15, 'modern_sofa1.jpg'),
(2, 'Classic Wooden Chair', 'A sturdy wooden chair made from high-quality oak wood.', 200.00, 95, 'classic_wooden_chair1.jpg'),
(3, 'Glass Coffee Table', 'A minimalist glass coffee table with a steel frame.', 350.00, 15, 'glass_coffee_table1.jpg'),
...
(8, 'Office Desk', 'A sleek office desk with a smooth finish and ample storage space.', 750.00, 20, 'office_desk1.jpg'),
(9, 'Accent Chair', 'A stylish accent chair with soft upholstery and a contemporary design.', 500.00, 18, 'accent_chair1.jpg'),
...
(50, 10, '2024-12-01 02:46:10', 1700.00, 0);
...
(7, 44, '', '2024-12-01 00:37:50', 'Confirmed'),
(8, 45, '', '2024-12-01 00:38:26', 'Shipped'),
(9, 46, '', '2024-12-01 01:13:30', 'Delivered'),
(17, 50, '', '2024-12-01 02:46:10', 'Pending');
...
(10, 'Fizi', 'mhafizfenaldhie2904@gmail.com', '$2y$10$7X2UY8OEydUOnrff8VpdAe71jY1Qa1lfZK/x1fVhS9GoCxvryqOpC', 'Jl. Raja Isa, Bisa Asri 1 Blok B1', '081267658409', '2024-10-28 19:02:17');
...
--
ALTER TABLE `furniture`
  MODIFY `furniture_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `order_details`
  MODIFY `order_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `shipment`
  MODIFY `shipment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
